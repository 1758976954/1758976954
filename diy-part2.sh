...
svn co  https://github.com/Lienol/openwrt-package/branches/other/luci-app-adguardhome.git package/lean/luci-app-adguardhome
...
#### 添加闪讯插件
git clone -b LUCI-LUA-UCITRACK https://github.com/CCnut/feed-netkeeper.git package/lean/feed-netkeeper
